function getFogDictionary() {
    return {
        ...
        "item.textarea.spec.length.restrictmethod": "Restringir tamanho",
        "item.textarea.spec.length.restrictmethod.by.character": "Por caractere",
        "item.textarea.spec.length.restrictmethod.by.word": "Por palavra",
        "item.textarea.spec.length.restrictmethod.no": "Não",
