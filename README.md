...
- Real-world approach. There are "Single choice" form fields instead of `<select>`. "Text" fields can be rendered as `<input>` or `<textarea>` according to what is set in its properties.
- Form validation.
